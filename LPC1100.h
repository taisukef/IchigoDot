...
//	BODCTRL = 0x13; // enable & 2.71
//	BODCTRL = 0x12; // enable & 2.43
//	BODCTRL = 0x11; // enable & 2.15
//	BODCTRL = 0x10; // enable & 1.63
//	BODCTRL = 0x00; // disable

// basic config

// Stack size (Must be multiple of 8. If zero, MSP is set to last RAM address)
#define STACK_SIZE	1024

// Main clock selection = 0:IRC(12MHz), 1:PLL-in, 2:WDT or 3:PLL-out
#define	CLK_SEL	3
// PLL input selection = 0:IRC osc (internal) or 1:Main osc (external)
#define OSC_SEL	0
...
// AHB  power SYSAHBCLKCTRL
#define AHB_SYS (1 << 0)
#define AHB_ROM (1 << 1)
#define AHB_RAM (1 << 2)
#define AHB_FLASHREG (1 << 3)
#define AHB_FLASHARRAY (1 << 4)
#define AHB_I2C (1 << 5)
#define AHB_GPIO (1 << 6)
...
#define AHB_BASIC (AHB_SYS | AHB_ROM | AHB_RAM | AHB_FLASHREG | AHB_FLASHARRAY | AHB_GPIO | AHB_IOCON)
